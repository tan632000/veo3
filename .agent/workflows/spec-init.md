...
3. **Initialize Files Using Templates**:
   - Read `.agent/skills/specs/templates/init.json`
   - Read `.agent/skills/specs/templates/requirements-init.md`
...
- **Template Missing**: If template files don't exist in `.agent/skills/specs/templates/`, report error with specific missing file path and suggest checking repository setup
