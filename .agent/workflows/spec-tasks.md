...
- Read `.agent/skills/specs/rules/tasks-generation.md` for principles
- If `sequential` is **false**: Read `.agent/skills/specs/rules/tasks-parallel-analysis.md` for parallel judgement criteria
- Read `.agent/skills/specs/templates/tasks.md` for format (supports `(P)` markers)
...
- **User Message**: "Template or rules files missing in `.agent/skills/specs/`"
